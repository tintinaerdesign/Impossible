...
export default function FirstPage() {
  ...
  return (
    <div className="bg-[#0f0f0f] text-white min-h-screen font-sans antialiased selection:bg-[#ec0065]/30">
      ...
      {/* Hero Section */}
      <section className="scroll-animate flex flex-col px-6 py-32 w-full min-h-[75vh] items-center justify-center text-center">
      ...
      <section
        className="scroll-animate max-w-5xl mx-auto py-12 px-6"
        id="price-widget"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="space-y-4">
            ...
            <button className="flex items-center gap-2 bg-gradient-to-r from-[#e60067] to-[#f05a28] hover:scale-105 active:scale-95 text-white font-medium px-6 py-3 rounded-xl transition shadow-lg shadow-[#e60067]/20 text-sm">
